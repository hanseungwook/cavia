...
def parse_args():
    ...
    parser.add_argument(
        '--task', type=str, default='mixture_regression', 
        choices=["sine", "celeba", "mixture_regression"],
        help='Task to perform meta-leraning')
    parser.add_argument(
        '--n_iter', type=int, default=50000, 
        help='number of meta-iterations')
    parser.add_argument(
        '--tasks_per_metaupdate', type=int, default=25)
    parser.add_argument(
    ...
    parser.add_argument(
        '--lr_inner', type=float, default=1.0, 
    ...
    parser.add_argument(
        '--num_context_params', type=int, default=5, help='number of context parameters (added at first layer)')
    parser.add_argument(
    ...
    parser.add_argument(
        '--maml', action='store_true', default=False, 
        help='run MAML')
    parser.add_argument(
        '--onehot', action='store_true', default=False, 
        help='run 1hot encoder version')
    parser.add_argument(
        '--model_type', type=str, default='ACTIVE', 
    ...
    parser.add_argument(
        '--logger_save_file', type=str, default='./loggers/logger', 
        help='Directory to save logger')
    parser.add_argument(
