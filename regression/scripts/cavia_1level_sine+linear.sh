...
--task sine+line_lv2 --n_contexts 4 0 --n_iters 3 0 2000 --for_iters 3 1 1 \
...
--log-name sine+line_lv1 --log_loss_levels 0 1 2 --log_ctx_levels 0 1 --task_separate_levels 0 1 2 \
--print_loss_levels 2 --private \
