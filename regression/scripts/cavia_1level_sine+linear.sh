...
python3 main_huh.py \
--task sine+line_lv2 --n_contexts 4 0 --n_iters 3 0 5000 --for_iters 3 1 1 \
...
--log-name sine+line_lv1 --log_level_loss 0 1 2 --log_level_ctx 0 1 --task_separate_levels 0 1 2 \
--log_print_levels 2 --private \
